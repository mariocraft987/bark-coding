...
content += '<a class="dark-mode-button" id="darkModeToggle"><dmbico alt="Dark Mode"></dmbico></a><form action="search.html"><input class="searchBar" id="search" name="search" placeholder="Search for Projects"></input></form></div>'
