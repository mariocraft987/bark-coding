...
let newsBox = "Try our new alpha <a href='https://github.com/mariocraft987/bark.github.io/releases/tag/0.0.1'>desktop app</a> it is missing a lot of functionality, but you can still do something, nmsderp made it"
...
content += '<a class="dark-mode-button" id="darkModeToggle"><dmbico alt="Dark Mode"></dmbico></a><form action="search.html?search=this%20is%20a%20test!"><input class="searchBar" id="search" placeholder="Search for Projects"></input></form></div>'
