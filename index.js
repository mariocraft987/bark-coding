...
let newsBox =  `
Bark is entering it's Christmas phase, so be sure to look out for secrets! /n WE REACHED 3000 COMMITS! we will celebrate by adding confetti thruout the whole website!
`;
