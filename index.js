...
function countrydropdown() {
    if (document.getElementById("countrydropdown") != null) {
        document.getElementById("countrydropdown").innerHTML = "<select name="country">
      ...
      <option value="The Solomon Islands">Solomon Islands</option>
      ...
      <option value="The United Arab Emirates">United Arab Emirates</option>
