...
content += '<a class="dark-mode-button" id="darkModeToggle"><dmbico alt="Dark Mode"></dmbico></a><form method="get" action="#"><input class="searchBar" id="search" placeholder="Search for Projects"></input></form></div>'
