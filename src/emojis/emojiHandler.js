...
function setupText() {
    ...
    .replace(":smiley:", "<img src='src/emojis/smiley.svg' alt='smiley' width='"+ emojiWidth + "' height='" + emojiHeight + "'>")
    ...
    .replace(":sussedOut:", "<img src='src/emojis/sussedOut.svg' alt='sussedOut' width='"+ emojiWidth + "' height='" + emojiHeight + "'>")
    ...
    .replace(":moneyEyes:", "<img src='src/emojis/moneyEyes.svg' alt='moneyEyes' width='"+ emojiWidth + "' height='" + emojiHeight + "'>")
