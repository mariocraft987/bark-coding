...
function replace(text) {
    return String(text)
        ...
        // emojis
        .replaceAll(":amazed:", "<img src='src/emojis/svg/amazed.svg' style='margin-bottom: -7px;' alt='amazed face' width='"+ emojiWidth + "'>")
        .replaceAll(":alien:", "<img src='src/emojis/svg/alien.svg' style='margin-bottom: -7px;' alt='alien' width='"+ emojiWidth + "'>")
        .replaceAll(":blank:", "<img src='src/emojis/svg/blank.svg' style='margin-bottom: -7px;' alt='blank face' width='"+ emojiWidth + "'>")
        .replaceAll(":smiley:", "<img src='src/emojis/svg/smiley.svg' alt='smiley face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":happy:", "<img src='src/emojis/svg/happy.svg' alt='happy face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":sad:", "<img src='src/emojis/svg/sad.svg' alt='sad face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":angry:", "<img src='src/emojis/svg/angry.svg' alt='angry face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":nerd:", "<img src='src/emojis/svg/nerd.svg' alt='nerd face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":lol:", "<img src='src/emojis/svg/lol.svg' alt='laughing face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":textHappy:", "<img src='src/emojis/svg/textHappy.svg' alt='happy face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":sussedOut:", "<img src='src/emojis/svg/sussedOut.svg' alt='suspicious face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":goofy:", "<img src='src/emojis/svg/goofy.svg' alt='goofy face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":mad:", "<img src='src/emojis/svg/mad.svg' alt='mad face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":joyful:", "<img src='src/emojis/svg/joyful.svg' alt='joyful face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":moneyEyes:", "<img src='src/emojis/svg/moneyEyes.svg' alt='face with money eyes' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":evil:", "<img src='src/emojis/svg/evil.svg' alt='evil face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":panic:", "<img src='src/emojis/svg/panic.svg' alt='panicking face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":dizzy:", "<img src='src/emojis/svg/dizzy.svg' alt='dizzy face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":jealous:", "<img src='src/emojis/svg/jealous.svg' alt='jealous face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":smallSmile:", "<img src='src/emojis/svg/smallsmile.svg' alt='face with small smile' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":troll:", "<img src='src/emojis/svg/troll.svg' alt='troll face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":woof:", "<img src='src/emojis/svg/bark.svg' alt='dog' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":fire:", "<img src='src/emojis/svg/fire.svg' alt='fire' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":pride:", "<img src='src/emojis/svg/pride.svg' alt='pride flag' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":rofl:", "<img src='src/emojis/svg/rofl.svg' alt='rofl' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":thumb:", "<img src='src/emojis/svg/thumb.svg' alt='thumbs up' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":robot:", "<img src='src/emojis/svg/robot.svg' alt='robot face' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":clap:", "<img src='src/emojis/svg/clap.svg' alt='clapping hands' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        .replaceAll(":clapAnim:", "<img src='src/emojis/svg/clap_anim.gif' alt='clapping hands' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
        ...
        // joke emojis
        .replaceAll(":mewing:", "<img src='src/emojis/svg/mewing.svg' alt='mewing' style='margin-bottom: -7px;' width='"+ emojiWidth + "'>")
