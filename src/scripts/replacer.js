...
function replace(text) {
    ...
    if (text.includes('suicide')) {
        location.href = "https://www.google.com/search?q=suicide+prevention&rlz=1C1VDKB_enUS1069US1069&oq=suicide+pervention&gs_lcrp=EgZjaHJvbWUqDAgBEAAYChixAxiABDIGCAAQRRg5MgwIARAAGAoYsQMYgAQyCQgCEAAYChiABDIPCAMQABgKGIMBGLEDGIAEMgkIBBAAGAoYgAQyCQgFEAAYChiABDIJCAYQABgKGIAEMgkIBxAAGAoYgAQyCQgIEAAYChiABDIJCAkQABgKGIAE0gEJMTQ1MjJqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8";
    }
}
