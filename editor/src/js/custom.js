Blockly.Blocks["default"] = {
  init: function () {
    this.appendDummyInput().appendField("Block name");
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldImage(
          "https://em-content.zobj.net/source/microsoft/379/dog-face_1f436.png",
          20,
          20,
          { alt: "A doggy from Mirosoft!", flipRtl: "FALSE" },
        ),
      );
    this.appendStatementInput("WHENBARKED").setCheck(null);
    this.setColour(20);
